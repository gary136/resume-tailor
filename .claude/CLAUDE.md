...
- Resume PDFs are ONE PAGE by default (user, 2026-07-27) — benefits the human reader, not the ATS parser. Enforced in render (dense CSS then top-N bullet trim, .md untouched) + targeted by the tailoring engine. Guide: docs/reference/resume-style-guide.md.
