...
def build_system_prompt(inventory: FactInventory, preferences: PreferenceRecord) -> str:
    ...
    return (
        ...
        "6. Keep it to ONE PAGE of content: prefer the 4-5 strongest, most job-relevant "
        "bullets per role; drop the weakest rather than padding. Concise reads as senior.\n"
        "7. Output ONLY the complete variant resume as markdown inside one ```markdown fence.\n\n"
